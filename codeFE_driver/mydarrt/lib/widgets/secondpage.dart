...
import 'package:mydarrt/model/driver.dart';
import 'package:mydarrt/view/idXE.dart';
import 'package:mydarrt/view/listIdVehicle.dart';

import 'package:mydarrt/widgets/firstpage.dart';
import '../view/sex.dart';
import '../view/tuyenxe.dart';
...
class _resgister extends State<register> {
  ...
  //   var url = 'http://localhost:8083/api/drivers';
  //   Data data = Data(
  //     id: "1",
  //     name: "Driver Name",
  ...
  Future<void> submitData() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://localhost:8084/api/drivers'),
      ...
      if (response.statusCode == 200) {
        ...
        final responsePut = await http.put(
          Uri.parse('http://localhost:8084/api/drivers/$driverId/route'),
        ...
        if (responsePut.statusCode == 200) {
          ...
          final responsePut2 = await http.put(
            Uri.parse('http://localhost:8084/api/drivers/$driverId/vehicle'),
          ...
          if (responsePut2.statusCode == 200) {
            ...
            final responsePut3 = await http.post(
              Uri.parse(
                  'http://localhost:8082/api/vehicle/addDriver/$idVehicle/$driverId'),
...
//       const url = 'localhost:8083/api/drivers';
